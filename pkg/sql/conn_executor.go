...
func NewServer(cfg *ExecutorConfig, pool *mon.BytesMonitor) *Server {
	...
	sqlStatsIngester := sslocal.NewSQLStatsIngester(
		cfg.Settings, cfg.SQLStatsTestingKnobs, serverMetrics.IngesterMetrics, pool,
		serverMetrics.StatsMetrics.DiscardedStatsCount, statementStore, insightsProvider, localSQLStats)
